<div class="row analogs_item">
		...
		<div class="col-md-8 analogs_item_details">
			<div class="analog_it_rate_ttl">
					[full-link]	<h3>{title}</h3>	[/full-link]
			</div>
<ul class="analog_icons_wrap">
		[xfvalue_icons]
			...
			<!-- <div class="analog_it_price">
				Цена на Ремантидин в аптеках: <br>
				от <strong>78₽</strong> до <strong>338₽</strong> <span>(5313 предложений)</span>
			</div> -->
